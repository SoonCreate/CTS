...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2014 at 06:51 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单反馈表' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单反馈明细表' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `ct_notices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户通知信息表' AUTO_INCREMENT=13 ;
...
(12, NULL, 0, NULL, 0, '关于投诉单105的反馈', 105, 45, 'http://localhost/cts/index.php/order/feedback?id=105', 0, 45, 1413693686, 1413693686, 45);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单信息表' AUTO_INCREMENT=106 ;
...
CREATE TABLE IF NOT EXISTS `ct_order_contents` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index_2` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单内容及回复表' AUTO_INCREMENT=156 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单日志记录表' AUTO_INCREMENT=204 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限表' AUTO_INCREMENT=132 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限明细表' AUTO_INCREMENT=212 ;
