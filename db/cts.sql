...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2014 at 01:06 PM
...
(37, 'feedback_star', '用户反馈的打分星数', '5', 1, 'number', NULL, NULL, NULL, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单反馈表' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单反馈明细表' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `ct_notices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户通知信息表' AUTO_INCREMENT=159 ;
...
(1, 21, 1, '', 1, '', 1, 44, '', 1, 44, 1412149769, 1413630240, 44),
(2, 22, 1, '', 1, '', 2, 44, '', 1, 44, 1412150096, 1413630240, 44),
(6, 26, 1, '从confirmed 变成 released', 1, '投诉单3 状态有新的变化', 3, 44, '', 1, 44, 1412150362, 1413630240, 44),
(7, 27, 1, '从allocated 变成 confirmed', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412216119, 1413630240, 44),
(8, 28, 1, '从done 变成 allocated', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412227442, 1413630240, 44),
(9, 29, 1, '从closed 变成 done', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412227657, 1413630240, 44),
(10, 30, 1, '从allocated 变成 confirmed', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412227892, 1413630240, 44),
(11, 33, 1, '从已分配 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412228471, 1413630240, 44),
(12, 34, 1, '从已分配 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412228630, 1413630240, 44),
(13, 35, 1, '责任人从 44 变成 40', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412228630, 1413630240, 44),
(14, 36, 1, '责任人从 40 变成 1', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412228914, 1413630240, 44),
(15, 37, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412232565, 1413630240, 44),
(16, 38, 1, '从已确认 变成 已分配', 1, '投诉单3 状态有新的变化', 3, 44, '', 1, 44, 1412232638, 1413630240, 44),
(17, 39, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 3 责任人变更', 3, 44, '', 1, 44, 1412232638, 1413630240, 44),
(18, 40, 1, '从已分配 变成 已解决', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412232766, 1413630240, 44),
(19, 41, 1, '从已解决 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412320728, 1413630240, 44),
(20, 42, 1, '从已关闭 变成 重新打开', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412320737, 1413630240, 44),
(21, 43, 1, '从已提交 变成 已确认', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399511, 1413630240, 44),
(22, 44, 1, '从已确认 变成 已分配', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399578, 1413630240, 44),
(23, 45, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 5 责任人变更', 5, 44, '', 1, 44, 1412399578, 1413630240, 44),
(24, 46, 1, '从已分配 变成 已解决', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399669, 1413630240, 44),
(25, 47, 1, '从已解决 变成 已关闭', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399684, 1413630240, 44),
(26, 48, 1, '从已关闭 变成 重新打开', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399692, 1413630240, 44),
(27, 49, 1, '从已提交 变成 已确认', 1, '投诉单9 状态有新的变化', 9, 44, '', 1, 44, 1412407466, 1413630240, 44),
(28, 50, 1, '从已确认 变成 已分配', 1, '投诉单9 状态有新的变化', 9, 44, '', 1, 44, 1412407511, 1413630240, 44),
(29, 51, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 9 责任人变更', 9, 44, '', 1, 44, 1412407511, 1413630240, 44),
(30, 52, 1, '从已提交 变成 已确认', 1, '投诉单17 状态有新的变化', 17, 44, '', 1, 44, 1412407646, 1413630240, 44),
(31, 53, 1, '从已确认 变成 已分配', 1, '投诉单17 状态有新的变化', 17, 44, '', 1, 44, 1412407667, 1413630240, 44),
(32, 54, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 17 责任人变更', 17, 44, '', 1, 44, 1412407667, 1413630240, 44),
(33, 55, 1, '从已提交 变成 已确认', 1, '投诉单7 状态有新的变化', 7, 44, '', 1, 44, 1412407737, 1413630240, 44),
(34, 56, 1, '从已确认 变成 已分配', 1, '投诉单7 状态有新的变化', 7, 44, '', 1, 44, 1412407744, 1413630240, 44),
(35, 57, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 7 责任人变更', 7, 44, '', 1, 44, 1412407744, 1413630240, 44),
(36, 58, 1, '从已提交 变成 已确认', 1, '投诉单8 状态有新的变化', 8, 44, '', 1, 44, 1412407914, 1413630240, 44),
(37, 59, 1, '从已确认 变成 已分配', 1, '投诉单8 状态有新的变化', 8, 44, '', 1, 44, 1412407920, 1413630240, 44),
(38, 60, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 8 责任人变更', 8, 44, '', 1, 44, 1412407920, 1413630240, 44),
(39, 61, 1, '从已提交 变成 已确认', 1, '投诉单10 状态有新的变化', 10, 44, '', 1, 44, 1412408011, 1413630240, 44),
(40, 62, 1, '从已确认 变成 已分配', 1, '投诉单10 状态有新的变化', 10, 44, '', 1, 44, 1412408161, 1413630240, 44),
(41, 63, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 10 责任人变更', 10, 44, '', 1, 44, 1412408161, 1413630240, 44),
(42, 64, 1, '从重新打开 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412408787, 1413630240, 44),
(43, 65, 1, '计划完成时间变更从1407686400 改为 1407686400 ', 1, '订单$order_id 计划完成日期变更', 2, 44, '', 1, 44, 1412408787, 1413630240, 44),
(44, 66, 1, '计划完成时间变更从2014-08-11 00:00:00 改为 2014-08-11 00:30:00 ', 1, '订单$order_id 计划完成日期变更', 2, 44, '', 1, 44, 1412410328, 1413630240, 44),
(45, 67, 1, '从已提交 变成 已确认', 1, '投诉单4 状态有新的变化', 4, 44, '', 1, 44, 1412412631, 1413630240, 44),
(46, 68, 1, '责任人从 速创科技工作室1 变成 asdfsadf', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412412997, 1413630240, 44),
(47, 69, 1, '从已确认 变成 已分配', 1, '投诉单4 状态有新的变化', 4, 44, '', 1, 44, 1412415137, 1413630240, 44),
(48, 70, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 4 责任人变更', 4, 44, '', 1, 44, 1412415138, 1413630240, 44),
(49, 71, 1, '计划完成时间变更从 改为 2014-09-10 00:00:00 ', 1, '订单$order_id 计划完成日期变更', 4, 44, '', 1, 44, 1412415138, 1413630240, 44),
(51, 73, 1, '责任人从 速创科技工作室1 变成 恭喜发财', 1, '订单 4 责任人变更', 4, 44, '', 1, 44, 1412415685, 1413630240, 44),
(52, 73, 0, '责任人从 速创科技工作室1 变成 恭喜发财', 1, '订单 4 责任人变更', 4, 66, '', 1, 44, 1412415686, 1412415686, 44),
(53, 74, 1, '从已分配 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 44, NULL, 1, 44, 1412732259, 1413630240, 44),
(54, 74, 0, '从已分配 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 66, NULL, 1, 44, 1412732259, 1412732259, 44),
(55, NULL, 1, NULL, 0, '关于投诉单2的反馈', 2, 44, 'http://localhost/cts/index.php/order/feedback?id=2', 0, 44, 1412732259, 1413630240, 44),
(56, 103, 1, 'content', 1, 'title', 65, 44, NULL, 1, 44, 1413531583, 1413630240, 44),
(57, 103, 1, 'content', 1, 'title', 65, 44, NULL, 1, 44, 1413531583, 1413630240, 44),
(58, 104, 1, 'content', 1, 'title', 66, 44, NULL, 1, 44, 1413531602, 1413630240, 44),
(59, 104, 1, 'content', 1, 'title', 66, 44, NULL, 1, 44, 1413531602, 1413630240, 44),
(60, 105, 1, 'content', 1, 'title', 67, 44, NULL, 1, 44, 1413531624, 1413630240, 44),
(61, 105, 1, 'content', 1, 'title', 67, 44, NULL, 1, 44, 1413531624, 1413630240, 44),
(62, 106, 1, 'content', 1, 'title', 68, 44, NULL, 1, 44, 1413531651, 1413630240, 44),
(63, 106, 1, 'content', 1, 'title', 68, 44, NULL, 1, 44, 1413531651, 1413630240, 44),
(64, 107, 1, 'content', 1, 'title', 69, 44, NULL, 1, 44, 1413531705, 1413630240, 44),
(65, 107, 1, 'content', 1, 'title', 69, 44, NULL, 1, 44, 1413531705, 1413630240, 44),
(66, 108, 1, 'content', 1, 'title', 70, 44, NULL, 1, 44, 1413531968, 1413630240, 44),
(67, 108, 1, 'content', 1, 'title', 70, 44, NULL, 1, 44, 1413531968, 1413630240, 44),
(68, 109, 1, 'content', 1, 'title', 71, 44, NULL, 1, 44, 1413532045, 1413630240, 44),
(69, 109, 1, 'content', 1, 'title', 71, 44, NULL, 1, 44, 1413532045, 1413630240, 44),
(70, 110, 1, '投诉单提交', 1, '投诉单72 状态有新的变化', 72, 44, NULL, 1, 44, 1413532174, 1413630240, 44),
(71, 110, 1, '投诉单提交', 1, '投诉单72 状态有新的变化', 72, 44, NULL, 1, 44, 1413532174, 1413630240, 44),
(72, 111, 1, '投诉单提交', 1, '投诉单73 状态有新的变化', 73, 44, NULL, 1, 44, 1413532233, 1413630240, 44),
(73, 111, 1, '投诉单提交', 1, '投诉单73 状态有新的变化', 73, 44, NULL, 1, 44, 1413532233, 1413630240, 44),
(80, 115, 1, '投诉单提交', 1, '投诉单77 状态有新的变化', 77, 44, NULL, 1, 44, 1413545424, 1413630240, 44),
(81, 115, 1, '投诉单提交', 1, '投诉单77 状态有新的变化', 77, 44, NULL, 1, 44, 1413545424, 1413630240, 44),
(82, 116, 1, '投诉单提交', 1, '投诉单78 状态有新的变化', 78, 44, NULL, 1, 44, 1413545651, 1413630240, 44),
(83, 116, 1, '投诉单提交', 1, '投诉单78 状态有新的变化', 78, 44, NULL, 1, 44, 1413545651, 1413630240, 44),
(84, 117, 1, '投诉单提交', 1, '投诉单79 状态有新的变化', 79, 44, NULL, 1, 44, 1413545690, 1413630240, 44),
(85, 117, 1, '投诉单提交', 1, '投诉单79 状态有新的变化', 79, 44, NULL, 1, 44, 1413545690, 1413630240, 44),
(86, 118, 1, '投诉单提交', 1, '投诉单80 状态有新的变化', 80, 44, NULL, 1, 44, 1413545846, 1413630240, 44),
(87, 118, 1, '投诉单提交', 1, '投诉单80 状态有新的变化', 80, 44, NULL, 1, 44, 1413545846, 1413630240, 44),
(88, 119, 1, '投诉单提交', 1, '投诉单81 状态有新的变化', 81, 44, NULL, 1, 44, 1413546023, 1413630240, 44),
(89, 119, 1, '投诉单提交', 1, '投诉单81 状态有新的变化', 81, 44, NULL, 1, 44, 1413546023, 1413630240, 44),
(90, 120, 1, '投诉单提交', 1, '投诉单82 状态有新的变化', 82, 44, NULL, 1, 44, 1413546035, 1413630240, 44),
(91, 120, 1, '投诉单提交', 1, '投诉单82 状态有新的变化', 82, 44, NULL, 1, 44, 1413546035, 1413630240, 44),
(92, 121, 1, '投诉单提交', 1, '投诉单83 状态有新的变化', 83, 44, NULL, 1, 44, 1413546112, 1413630240, 44),
(93, 121, 1, '投诉单提交', 1, '投诉单83 状态有新的变化', 83, 44, NULL, 1, 44, 1413546112, 1413630240, 44),
(94, 122, 1, '投诉单提交', 1, '投诉单84 状态有新的变化', 84, 44, NULL, 1, 44, 1413546149, 1413630240, 44),
(95, 122, 1, '投诉单提交', 1, '投诉单84 状态有新的变化', 84, 44, NULL, 1, 44, 1413546149, 1413630240, 44),
(96, 123, 1, '投诉单提交', 1, '投诉单85 状态有新的变化', 85, 44, NULL, 1, 44, 1413546302, 1413630240, 44),
(97, 123, 1, '投诉单提交', 1, '投诉单85 状态有新的变化', 85, 44, NULL, 1, 44, 1413546302, 1413630240, 44),
(98, 124, 1, '投诉单提交', 1, '投诉单86 状态有新的变化', 86, 44, NULL, 1, 44, 1413546327, 1413630240, 44),
(99, 124, 1, '投诉单提交', 1, '投诉单86 状态有新的变化', 86, 44, NULL, 1, 44, 1413546327, 1413630240, 44),
(100, 125, 1, '投诉单提交', 1, '投诉单87 状态有新的变化', 87, 44, NULL, 1, 44, 1413546466, 1413630240, 44),
(101, 125, 1, '投诉单提交', 1, '投诉单87 状态有新的变化', 87, 44, NULL, 1, 44, 1413546466, 1413630240, 44),
(102, 126, 1, '投诉单提交', 1, '投诉单88 状态有新的变化', 88, 44, NULL, 1, 44, 1413547082, 1413630240, 44),
(103, 126, 1, '投诉单提交', 1, '投诉单88 状态有新的变化', 88, 44, NULL, 1, 44, 1413547082, 1413630240, 44),
(104, 127, 1, '投诉单提交', 1, '投诉单89 状态有新的变化', 89, 44, NULL, 1, 44, 1413547106, 1413630240, 44),
(105, 127, 1, '投诉单提交', 1, '投诉单89 状态有新的变化', 89, 44, NULL, 1, 44, 1413547106, 1413630240, 44),
(106, 128, 1, '投诉单提交', 1, '投诉单90 状态有新的变化', 90, 44, NULL, 1, 44, 1413547147, 1413630240, 44),
(107, 128, 1, '投诉单提交', 1, '投诉单90 状态有新的变化', 90, 44, NULL, 1, 44, 1413547147, 1413630240, 44),
(108, 134, 1, '责任人从 未知 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413548938, 1413630240, 44),
(109, 135, 1, '计划完成时间变更从 改为 1970-01-01 08:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413548938, 1413630240, 44),
(110, 138, 1, '责任人从 速创科技工作室 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413550556, 1413630240, 44),
(111, 138, 1, '责任人从 速创科技工作室 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413550556, 1413630240, 44),
(112, 139, 1, '计划完成时间变更从1970-01-01 08:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550556, 1413630240, 44),
(113, 139, 1, '计划完成时间变更从1970-01-01 08:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550556, 1413630240, 44),
(114, 141, 1, '计划完成时间变更从2014-10-17 00:00:00 改为 2014-10-18 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550974, 1413630240, 44),
(115, 141, 1, '计划完成时间变更从2014-10-17 00:00:00 改为 2014-10-18 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550974, 1413630240, 44),
(116, 142, 1, '计划完成时间变更从2014-10-18 00:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413551190, 1413630240, 44),
(117, 142, 1, '计划完成时间变更从2014-10-18 00:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413551190, 1413630240, 44),
(118, 143, 1, '投诉单状态： 已分配 => 已解决 ', 1, '投诉单90 已解决', 90, 44, NULL, 1, 44, 1413551407, 1413630240, 44),
(119, NULL, 1, NULL, 0, '关于投诉单90的反馈', 90, 44, 'http://localhost/cts/index.php/order/feedback?id=90', 0, 44, 1413551443, 1413630240, 44),
(120, 148, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413630240, 44),
(121, 148, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413630240, 44),
(122, 148, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413630240, 44),
(123, NULL, 1, NULL, 0, '关于投诉单90的反馈', 90, 44, 'http://localhost/cts/index.php/order/feedback?id=90', 0, 44, 1413552345, 1413630240, 44),
(124, 151, 1, '责任人从 未知 变成 速创科技工作室', 1, '订单 86 责任人变更', 86, 44, NULL, 1, 44, 1413554326, 1413630240, 44),
(125, 152, 1, '计划完成时间变更从 改为 2014-10-17 00:00:00 ', 1, '订单86 计划完成日期变更', 86, 44, NULL, 1, 44, 1413554326, 1413630240, 44),
(126, 153, 1, '投诉单状态： 已分配 => 已解决 ', 1, '投诉单86 已解决', 86, 44, NULL, 1, 44, 1413554385, 1413630240, 44),
(127, NULL, 1, NULL, 0, '关于投诉单86的反馈', 86, 44, 'http://localhost/cts/index.php/order/feedback?id=86', 0, 44, 1413554392, 1413630240, 44),
(128, 154, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单86被重新打开', 86, 44, NULL, 1, 44, 1413554428, 1413630240, 44),
(129, 154, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单86被重新打开', 86, 44, NULL, 1, 44, 1413554428, 1413630240, 44),
(130, 154, 1, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单86被重新打开', 86, 44, NULL, 1, 44, 1413554428, 1413630240, 44),
(131, NULL, 1, NULL, 0, '关于投诉单86的反馈', 86, 44, 'http://localhost/cts/index.php/order/feedback?id=86', 0, 44, 1413554629, 1413630240, 44),
(132, NULL, 1, NULL, 0, '关于投诉单89的反馈', 89, 44, 'http://localhost/cts/index.php/order/feedback?id=89', 0, 44, 1413555683, 1413630240, 44),
(133, 161, 1, '投诉单提交', 1, '投诉单 97 提交', 97, 44, NULL, 1, 44, 1413559897, 1413630240, 44),
(134, 161, 1, '投诉单提交', 1, '投诉单 97 提交', 97, 44, NULL, 1, 44, 1413559897, 1413630240, 44),
(135, 162, 1, '投诉单提交', 1, '投诉单 98 提交', 98, 44, NULL, 1, 44, 1413559928, 1413630240, 44),
(136, 162, 1, '投诉单提交', 1, '投诉单 98 提交', 98, 44, NULL, 1, 44, 1413559928, 1413630240, 44),
(137, 168, 1, '投诉单提交', 1, '投诉单 99 提交', 99, 44, NULL, 1, 44, 1413560227, 1413630240, 44),
(138, 168, 1, '投诉单提交', 1, '投诉单 99 提交', 99, 44, NULL, 1, 44, 1413560227, 1413630240, 44),
(139, 169, 1, '投诉单提交', 1, '投诉单 100 提交', 100, 44, NULL, 1, 44, 1413562846, 1413630240, 44),
(140, 170, 1, '投诉单提交', 1, '投诉单 101 提交', 101, 44, NULL, 1, 44, 1413562875, 1413630240, 44),
...
(144, 175, 1, '责任人从 高哨 变成 速创科技工作室', 1, '订单 101 责任人变更', 101, 44, NULL, 1, 44, 1413563071, 1413630240, 44),
(145, 179, 1, '已解决 => 已关闭', 1, '投诉单 101状态更新', 101, 44, NULL, 1, 44, 1413563623, 1413630240, 44),
(146, NULL, 1, NULL, 0, '关于投诉单101的反馈', 101, 44, 'http://localhost/cts/index.php/order/feedback?id=101', 0, 44, 1413563623, 1413630240, 44),
(147, 180, 1, '已关闭 => 重新打开', 1, '投诉单 101状态更新', 101, 44, NULL, 1, 44, 1413563650, 1413630240, 44),
(148, 180, 1, '已关闭 => 重新打开', 1, '投诉单 101状态更新', 101, 44, NULL, 1, 44, 1413563650, 1413630240, 44),
(149, 181, 1, '投诉单提交', 1, '投诉单 102 提交', 102, 44, NULL, 1, 44, 1413563758, 1413630240, 44),
(150, 183, 1, '责任人从 未知 变成 速创科技工作室', 1, '投诉单 102 责任人变更', 102, 44, NULL, 1, 44, 1413563776, 1413630240, 44),
(151, 185, 1, '已确认 => 已分配', 1, '投诉单 102状态更新', 102, 44, NULL, 1, 44, 1413563776, 1413630240, 44),
(152, 186, 1, '已分配 => 已解决', 1, '投诉单 102状态更新', 102, 44, NULL, 1, 44, 1413563825, 1413630240, 44),
(153, 188, 1, '责任人从 未知 变成 速创科技工作室', 1, '投诉单 99 责任人变更', 99, 44, NULL, 1, 44, 1413563855, 1413630240, 44),
(154, 190, 1, '已确认 => 已分配', 1, '投诉单 99状态更新', 99, 44, NULL, 1, 44, 1413563855, 1413630240, 44),
(155, 191, 1, '已解决 => 已关闭', 1, '投诉单 102状态更新', 102, 44, NULL, 1, 44, 1413617064, 1413630240, 44),
(156, NULL, 1, NULL, 0, '关于投诉单102的反馈', 102, 44, 'http://localhost/cts/index.php/order/feedback?id=102', 0, 44, 1413617064, 1413630240, 44),
(157, 192, 1, '重新打开 => 已关闭', 1, '投诉单 101状态更新', 101, 44, NULL, 1, 44, 1413625258, 1413630240, 44),
(158, NULL, 1, NULL, 0, '关于投诉单101的反馈', 101, 44, 'http://localhost/cts/index.php/order/feedback?id=101', 0, 44, 1413625258, 1413630240, 44);
...
CREATE TABLE IF NOT EXISTS `ct_order_contents` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index_2` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单内容及回复表' AUTO_INCREMENT=144 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单日志记录表' AUTO_INCREMENT=193 ;
...
(44, 'yacole', 'fbeae417c84f2bf1121ab58c55105b4247c8e069', 'male', '陈杨阳', 'yacole@qq.com', '13777777777', '13989775601', '乐清柳市镇', '速创科技工作室', 0, 1, 0, 0, -1, 1412039595, 1413464711, 44),
