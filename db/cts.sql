...
CREATE TABLE IF NOT EXISTS `ct_notices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户通知信息表' AUTO_INCREMENT=64 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单信息表' AUTO_INCREMENT=122 ;
...
(105, 'customer', 'closed', 'low', 'low', '10', '演示客户投诉单', 67, 1413648000, '陈某某', '', '13777777777', '', '', 0, 1413690191, 45, 1413693685, 45),
(106, 'vendor', 'closed', 'low', 'middle', '40', '服务人员骂人', 66, 1413648000, '陈阵', '54432323', '1314243345', '32324342', '2343224322', 0, 1413697975, 46, 1413700532, 66),
(107, 'employee', 'confirmed', 'middle', 'middle', '30', '办公室有人吸烟', NULL, NULL, '洪仙横', '', '1387777777', '', '天正', 0, 1413698090, 47, 1413698863, 48),
(108, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699551, 69, 1413699551, 69),
(109, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699577, 69, 1413699577, 69),
(110, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699619, 69, 1413699619, 69),
(111, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699643, 69, 1413699643, 69),
(112, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699678, 69, 1413699678, 69),
(113, 'vendor', 'released', 'low', 'low', '10', '测', NULL, NULL, '飞', '', '1', '', '', 0, 1413699714, 69, 1413699714, 69),
(114, 'vendor', 'allocated', 'low', 'low', '10', '测', 66, 1413734400, '飞', '', '1', '', '', 0, 1413699726, 69, 1413700139, 48),
(115, 'vendor', 'closed', 'low', 'low', '30', '供应商投诉测试shimhen1', 66, 1413993600, '洪仙横', '0577-62888888', '13867777777', '乐清市建设中路12号', '速创科技合伙企业', 0, 1413699736, 69, 1413700629, 66),
(116, 'vendor', 'released', 'high', 'high', '10', '跳闸', NULL, NULL, '张三', '8888888888', '13777777777', '乐清市经济开发期纬8路', '浙江**有限公司', 0, 1413699897, 69, 1413699897, 69),
(117, 'customer', 'released', 'low', 'low', '20', '客户投诉测试1', NULL, NULL, '客户1', '', '13877787678', '', '', 0, 1413700212, 69, 1413700212, 69),
(118, 'employee', 'released', 'low', 'low', '30', '内部员工投诉测试1', NULL, NULL, '内部1', '', '138787878787', '', '', 0, 1413700252, 69, 1413700252, 69),
(119, 'customer', 'released', 'low', 'low', '10', '我是客户李四', NULL, NULL, '李四', '0577-68873723', '139898989', 'ABC路88号', '速创科技', 0, 1413702543, 45, 1413702543, 45),
(120, 'vendor', 'allocated', 'low', 'low', '10', '2222', 66, 1413993600, '123', '', '123', '', '', 0, 1413704181, 46, 1413704365, 48),
(121, 'customer', 'closed', 'low', 'low', '10', 'DZ47质量问题', 67, 1413820800, '李四', '0577-68873723', '139898989', 'ABC路88号', '速创科技', 0, 1413705930, 45, 1413707410, 45);
...
CREATE TABLE IF NOT EXISTS `ct_order_contents` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index_2` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单内容及回复表' AUTO_INCREMENT=178 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投诉单日志记录表' AUTO_INCREMENT=252 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限表' AUTO_INCREMENT=133 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限明细表' AUTO_INCREMENT=214 ;
...
(124, 83, 4, 'confirmed,allocated', 1413678353, 47, 1413678425, 47),
...
(138, 91, 4, 'done,closed,reopen', 1413687228, 44, 1413687298, 44),
...
(145, 95, 4, 'done', 1413687331, 44, 1413687355, 44),
...
(152, 99, 4, 'done,closed,reopen', 1413687440, 44, 1413687489, 44),
...
(66, 'manager_vendor', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'male', '采购经理测试账号', '383731104@qq.com', '', '', '', '采购经理测试账号', 0, 1, 0, 1, 44, 1412231054, 1413704167, 66),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户角色对应表' AUTO_INCREMENT=79 ;
