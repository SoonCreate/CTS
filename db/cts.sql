...
CREATE TABLE IF NOT EXISTS `ct_module_lines` (
  ...
  `last_updated_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统模块明细表' AUTO_INCREMENT=39 ;
...
(1, 21, 1, '', 1, '', 1, 44, '', 1, 44, 1412149769, 1413459993, 44),
(2, 22, 1, '', 1, '', 2, 44, '', 1, 44, 1412150096, 1413459993, 44),
(6, 26, 1, '从confirmed 变成 released', 1, '投诉单3 状态有新的变化', 3, 44, '', 1, 44, 1412150362, 1413459993, 44),
(7, 27, 1, '从allocated 变成 confirmed', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412216119, 1413459993, 44),
(8, 28, 1, '从done 变成 allocated', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412227442, 1413459993, 44),
(9, 29, 1, '从closed 变成 done', 1, '投诉单1 状态有新的变化', 1, 44, '', 1, 44, 1412227657, 1413459993, 44),
(10, 30, 1, '从allocated 变成 confirmed', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412227892, 1413459993, 44),
(11, 33, 1, '从已分配 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412228471, 1413459993, 44),
(12, 34, 1, '从已分配 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412228630, 1413459993, 44),
(13, 35, 1, '责任人从 44 变成 40', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412228630, 1413459993, 44),
(14, 36, 1, '责任人从 40 变成 1', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412228914, 1413459993, 44),
(15, 37, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412232565, 1413459993, 44),
(16, 38, 1, '从已确认 变成 已分配', 1, '投诉单3 状态有新的变化', 3, 44, '', 1, 44, 1412232638, 1413459993, 44),
(17, 39, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 3 责任人变更', 3, 44, '', 1, 44, 1412232638, 1413459993, 44),
(18, 40, 1, '从已分配 变成 已解决', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412232766, 1413459993, 44),
(19, 41, 1, '从已解决 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412320728, 1413459993, 44),
(20, 42, 1, '从已关闭 变成 重新打开', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412320737, 1413459993, 44),
(21, 43, 1, '从已提交 变成 已确认', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399511, 1413459993, 44),
(22, 44, 1, '从已确认 变成 已分配', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399578, 1413459993, 44),
(23, 45, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 5 责任人变更', 5, 44, '', 1, 44, 1412399578, 1413459993, 44),
(24, 46, 1, '从已分配 变成 已解决', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399669, 1413459993, 44),
(25, 47, 1, '从已解决 变成 已关闭', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399684, 1413459993, 44),
(26, 48, 1, '从已关闭 变成 重新打开', 1, '投诉单5 状态有新的变化', 5, 44, '', 1, 44, 1412399692, 1413459993, 44),
(27, 49, 1, '从已提交 变成 已确认', 1, '投诉单9 状态有新的变化', 9, 44, '', 1, 44, 1412407466, 1413459993, 44),
(28, 50, 1, '从已确认 变成 已分配', 1, '投诉单9 状态有新的变化', 9, 44, '', 1, 44, 1412407511, 1413459993, 44),
(29, 51, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 9 责任人变更', 9, 44, '', 1, 44, 1412407511, 1413459993, 44),
(30, 52, 1, '从已提交 变成 已确认', 1, '投诉单17 状态有新的变化', 17, 44, '', 1, 44, 1412407646, 1413459993, 44),
(31, 53, 1, '从已确认 变成 已分配', 1, '投诉单17 状态有新的变化', 17, 44, '', 1, 44, 1412407667, 1413459993, 44),
(32, 54, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 17 责任人变更', 17, 44, '', 1, 44, 1412407667, 1413459993, 44),
(33, 55, 1, '从已提交 变成 已确认', 1, '投诉单7 状态有新的变化', 7, 44, '', 1, 44, 1412407737, 1413459993, 44),
(34, 56, 1, '从已确认 变成 已分配', 1, '投诉单7 状态有新的变化', 7, 44, '', 1, 44, 1412407744, 1413459993, 44),
(35, 57, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 7 责任人变更', 7, 44, '', 1, 44, 1412407744, 1413459993, 44),
(36, 58, 1, '从已提交 变成 已确认', 1, '投诉单8 状态有新的变化', 8, 44, '', 1, 44, 1412407914, 1413459993, 44),
(37, 59, 1, '从已确认 变成 已分配', 1, '投诉单8 状态有新的变化', 8, 44, '', 1, 44, 1412407920, 1413459993, 44),
(38, 60, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 8 责任人变更', 8, 44, '', 1, 44, 1412407920, 1413459993, 44),
(39, 61, 1, '从已提交 变成 已确认', 1, '投诉单10 状态有新的变化', 10, 44, '', 1, 44, 1412408011, 1413459993, 44),
(40, 62, 1, '从已确认 变成 已分配', 1, '投诉单10 状态有新的变化', 10, 44, '', 1, 44, 1412408161, 1413459993, 44),
(41, 63, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 10 责任人变更', 10, 44, '', 1, 44, 1412408161, 1413459993, 44),
(42, 64, 1, '从重新打开 变成 已分配', 1, '投诉单2 状态有新的变化', 2, 44, '', 1, 44, 1412408787, 1413459993, 44),
(43, 65, 1, '计划完成时间变更从1407686400 改为 1407686400 ', 1, '订单$order_id 计划完成日期变更', 2, 44, '', 1, 44, 1412408787, 1413459993, 44),
(44, 66, 1, '计划完成时间变更从2014-08-11 00:00:00 改为 2014-08-11 00:30:00 ', 1, '订单$order_id 计划完成日期变更', 2, 44, '', 1, 44, 1412410328, 1413459993, 44),
(45, 67, 1, '从已提交 变成 已确认', 1, '投诉单4 状态有新的变化', 4, 44, '', 1, 44, 1412412631, 1413459993, 44),
(46, 68, 1, '责任人从 速创科技工作室1 变成 asdfsadf', 1, '订单 2 责任人变更', 2, 44, '', 1, 44, 1412412997, 1413459993, 44),
(47, 69, 1, '从已确认 变成 已分配', 1, '投诉单4 状态有新的变化', 4, 44, '', 1, 44, 1412415137, 1413459993, 44),
(48, 70, 1, '责任人从 未知 变成 速创科技工作室1', 1, '订单 4 责任人变更', 4, 44, '', 1, 44, 1412415138, 1413459993, 44),
(49, 71, 1, '计划完成时间变更从 改为 2014-09-10 00:00:00 ', 1, '订单$order_id 计划完成日期变更', 4, 44, '', 1, 44, 1412415138, 1413459993, 44),
(51, 73, 1, '责任人从 速创科技工作室1 变成 恭喜发财', 1, '订单 4 责任人变更', 4, 44, '', 1, 44, 1412415685, 1413459993, 44),
(52, 73, 0, '责任人从 速创科技工作室1 变成 恭喜发财', 1, '订单 4 责任人变更', 4, 66, '', 1, 44, 1412415686, 1412415686, 44),
(53, 74, 1, '从已分配 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 44, NULL, 1, 44, 1412732259, 1413459993, 44),
(54, 74, 0, '从已分配 变成 已关闭', 1, '投诉单2 状态有新的变化', 2, 66, NULL, 1, 44, 1412732259, 1412732259, 44),
(55, NULL, 1, NULL, 0, '关于投诉单2的反馈', 2, 44, 'http://localhost/cts/index.php/order/feedback?id=2', 0, 44, 1412732259, 1413459993, 44),
(56, 103, 0, 'content', 1, 'title', 65, 44, NULL, 1, 44, 1413531583, 1413531583, 44),
(57, 103, 1, 'content', 1, 'title', 65, 44, NULL, 1, 44, 1413531583, 1413531800, 44),
(58, 104, 0, 'content', 1, 'title', 66, 44, NULL, 1, 44, 1413531602, 1413531602, 44),
(59, 104, 0, 'content', 1, 'title', 66, 44, NULL, 1, 44, 1413531602, 1413531602, 44),
(60, 105, 0, 'content', 1, 'title', 67, 44, NULL, 1, 44, 1413531624, 1413531624, 44),
(61, 105, 0, 'content', 1, 'title', 67, 44, NULL, 1, 44, 1413531624, 1413531624, 44),
(62, 106, 0, 'content', 1, 'title', 68, 44, NULL, 1, 44, 1413531651, 1413531651, 44),
(63, 106, 0, 'content', 1, 'title', 68, 44, NULL, 1, 44, 1413531651, 1413531651, 44),
(64, 107, 0, 'content', 1, 'title', 69, 44, NULL, 1, 44, 1413531705, 1413531705, 44),
(65, 107, 0, 'content', 1, 'title', 69, 44, NULL, 1, 44, 1413531705, 1413531705, 44),
(66, 108, 0, 'content', 1, 'title', 70, 44, NULL, 1, 44, 1413531968, 1413531968, 44),
(67, 108, 0, 'content', 1, 'title', 70, 44, NULL, 1, 44, 1413531968, 1413531968, 44),
(68, 109, 0, 'content', 1, 'title', 71, 44, NULL, 1, 44, 1413532045, 1413532045, 44),
(69, 109, 0, 'content', 1, 'title', 71, 44, NULL, 1, 44, 1413532045, 1413532045, 44),
(70, 110, 0, '投诉单提交', 1, '投诉单72 状态有新的变化', 72, 44, NULL, 1, 44, 1413532174, 1413532174, 44),
(71, 110, 0, '投诉单提交', 1, '投诉单72 状态有新的变化', 72, 44, NULL, 1, 44, 1413532174, 1413532174, 44),
(72, 111, 1, '投诉单提交', 1, '投诉单73 状态有新的变化', 73, 44, NULL, 1, 44, 1413532233, 1413544843, 44),
(73, 111, 1, '投诉单提交', 1, '投诉单73 状态有新的变化', 73, 44, NULL, 1, 44, 1413532233, 1413544941, 44),
(80, 115, 0, '投诉单提交', 1, '投诉单77 状态有新的变化', 77, 44, NULL, 1, 44, 1413545424, 1413545424, 44),
(81, 115, 0, '投诉单提交', 1, '投诉单77 状态有新的变化', 77, 44, NULL, 1, 44, 1413545424, 1413545424, 44),
(82, 116, 0, '投诉单提交', 1, '投诉单78 状态有新的变化', 78, 44, NULL, 1, 44, 1413545651, 1413545651, 44),
(83, 116, 0, '投诉单提交', 1, '投诉单78 状态有新的变化', 78, 44, NULL, 1, 44, 1413545651, 1413545651, 44),
(84, 117, 0, '投诉单提交', 1, '投诉单79 状态有新的变化', 79, 44, NULL, 1, 44, 1413545690, 1413545690, 44),
(85, 117, 0, '投诉单提交', 1, '投诉单79 状态有新的变化', 79, 44, NULL, 1, 44, 1413545690, 1413545690, 44),
(86, 118, 0, '投诉单提交', 1, '投诉单80 状态有新的变化', 80, 44, NULL, 1, 44, 1413545846, 1413545846, 44),
(87, 118, 0, '投诉单提交', 1, '投诉单80 状态有新的变化', 80, 44, NULL, 1, 44, 1413545846, 1413545846, 44),
(88, 119, 0, '投诉单提交', 1, '投诉单81 状态有新的变化', 81, 44, NULL, 1, 44, 1413546023, 1413546023, 44),
(89, 119, 0, '投诉单提交', 1, '投诉单81 状态有新的变化', 81, 44, NULL, 1, 44, 1413546023, 1413546023, 44),
(90, 120, 0, '投诉单提交', 1, '投诉单82 状态有新的变化', 82, 44, NULL, 1, 44, 1413546035, 1413546035, 44),
(91, 120, 0, '投诉单提交', 1, '投诉单82 状态有新的变化', 82, 44, NULL, 1, 44, 1413546035, 1413546035, 44),
(92, 121, 0, '投诉单提交', 1, '投诉单83 状态有新的变化', 83, 44, NULL, 1, 44, 1413546112, 1413546112, 44),
(93, 121, 0, '投诉单提交', 1, '投诉单83 状态有新的变化', 83, 44, NULL, 1, 44, 1413546112, 1413546112, 44),
(94, 122, 0, '投诉单提交', 1, '投诉单84 状态有新的变化', 84, 44, NULL, 1, 44, 1413546149, 1413546149, 44),
(95, 122, 0, '投诉单提交', 1, '投诉单84 状态有新的变化', 84, 44, NULL, 1, 44, 1413546149, 1413546149, 44),
(96, 123, 0, '投诉单提交', 1, '投诉单85 状态有新的变化', 85, 44, NULL, 1, 44, 1413546302, 1413546302, 44),
(97, 123, 0, '投诉单提交', 1, '投诉单85 状态有新的变化', 85, 44, NULL, 1, 44, 1413546302, 1413546302, 44),
(98, 124, 0, '投诉单提交', 1, '投诉单86 状态有新的变化', 86, 44, NULL, 1, 44, 1413546327, 1413546327, 44),
(99, 124, 0, '投诉单提交', 1, '投诉单86 状态有新的变化', 86, 44, NULL, 1, 44, 1413546327, 1413546327, 44),
(100, 125, 0, '投诉单提交', 1, '投诉单87 状态有新的变化', 87, 44, NULL, 1, 44, 1413546466, 1413546466, 44),
(101, 125, 0, '投诉单提交', 1, '投诉单87 状态有新的变化', 87, 44, NULL, 1, 44, 1413546466, 1413546466, 44),
(102, 126, 0, '投诉单提交', 1, '投诉单88 状态有新的变化', 88, 44, NULL, 1, 44, 1413547082, 1413547082, 44),
(103, 126, 0, '投诉单提交', 1, '投诉单88 状态有新的变化', 88, 44, NULL, 1, 44, 1413547082, 1413547082, 44),
(104, 127, 0, '投诉单提交', 1, '投诉单89 状态有新的变化', 89, 44, NULL, 1, 44, 1413547106, 1413547106, 44),
(105, 127, 0, '投诉单提交', 1, '投诉单89 状态有新的变化', 89, 44, NULL, 1, 44, 1413547106, 1413547106, 44),
(106, 128, 0, '投诉单提交', 1, '投诉单90 状态有新的变化', 90, 44, NULL, 1, 44, 1413547147, 1413547147, 44),
(107, 128, 0, '投诉单提交', 1, '投诉单90 状态有新的变化', 90, 44, NULL, 1, 44, 1413547147, 1413547147, 44),
(108, 134, 0, '责任人从 未知 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413548938, 1413548938, 44),
(109, 135, 0, '计划完成时间变更从 改为 1970-01-01 08:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413548938, 1413548938, 44),
(110, 138, 0, '责任人从 速创科技工作室 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413550556, 1413550556, 44),
(111, 138, 0, '责任人从 速创科技工作室 变成 速创科技工作室', 1, '订单 90 责任人变更', 90, 44, NULL, 1, 44, 1413550556, 1413550556, 44),
(112, 139, 0, '计划完成时间变更从1970-01-01 08:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550556, 1413550556, 44),
(113, 139, 0, '计划完成时间变更从1970-01-01 08:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550556, 1413550556, 44),
(114, 141, 0, '计划完成时间变更从2014-10-17 00:00:00 改为 2014-10-18 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550974, 1413550974, 44),
(115, 141, 0, '计划完成时间变更从2014-10-17 00:00:00 改为 2014-10-18 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413550974, 1413550974, 44),
(116, 142, 0, '计划完成时间变更从2014-10-18 00:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413551190, 1413551190, 44),
(117, 142, 0, '计划完成时间变更从2014-10-18 00:00:00 改为 2014-10-17 00:00:00 ', 1, '订单90 计划完成日期变更', 90, 44, NULL, 1, 44, 1413551190, 1413551190, 44),
(118, 143, 1, '投诉单状态： 已分配 => 已解决 ', 1, '投诉单90 已解决', 90, 44, NULL, 1, 44, 1413551407, 1413551415, 44),
(119, NULL, 0, NULL, 0, '关于投诉单90的反馈', 90, 44, 'http://localhost/cts/index.php/order/feedback?id=90', 0, 44, 1413551443, 1413551443, 44),
(120, 148, 0, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413552179, 44),
(121, 148, 0, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413552179, 44),
(122, 148, 0, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单90被重新打开', 90, 44, NULL, 1, 44, 1413552179, 1413552179, 44),
(123, NULL, 1, NULL, 0, '关于投诉单90的反馈', 90, 44, 'http://localhost/cts/index.php/order/feedback?id=90', 0, 44, 1413552345, 1413552368, 44),
(124, 151, 0, '责任人从 未知 变成 速创科技工作室', 1, '订单 86 责任人变更', 86, 44, NULL, 1, 44, 1413554326, 1413554326, 44),
(125, 152, 0, '计划完成时间变更从 改为 2014-10-17 00:00:00 ', 1, '订单86 计划完成日期变更', 86, 44, NULL, 1, 44, 1413554326, 1413554326, 44),
(126, 153, 0, '投诉单状态： 已分配 => 已解决 ', 1, '投诉单86 已解决', 86, 44, NULL, 1, 44, 1413554385, 1413554385, 44),
(127, NULL, 0, NULL, 0, '关于投诉单86的反馈', 86, 44, 'http://localhost/cts/index.php/order/feedback?id=86', 0, 44, 1413554392, 1413554392, 44),
(128, 154, 0, '投诉单状态： 已关闭 => 重新打开 ', 1, '投诉单86被重新打开', 86, 44, NULL, 1, 44, 1413554428, 1413554428, 44),
