...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2014 at 05:40 AM
...
(6, 2, 11, 'all', NULL, NULL, 1413687397, 44),
...
CREATE TABLE IF NOT EXISTS `ct_module_lines` (
  ...
  `last_updated_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统模块明细表' AUTO_INCREMENT=46 ;
...
CREATE TABLE IF NOT EXISTS `ct_notices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户通知信息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ct_role_module_lines` (
  ...
  `last_updated_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应功能表' AUTO_INCREMENT=134 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限表' AUTO_INCREMENT=119 ;
...
(112, 13, 2, 1413687790, 44, 1413687790, 44, NULL),
...
(116, 14, 2, 1413687843, 44, 1413687843, 44, NULL),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色对应权限明细表' AUTO_INCREMENT=186 ;
...
(55, 49, 6, 'TRUE', 1413034064, 44, 1413687759, 44),
...
(115, 78, 6, 'TRUE', 1413677749, 44, 1413677749, 44),
...
(119, 80, 6, 'TRUE', 1413678056, 46, 1413678056, 46),
(120, 81, 7, 'all', 1413678059, 46, 1413678059, 46),
(121, 82, 8, 'TRUE', 1413678062, 46, 1413678062, 46),
...
(126, 84, 6, 'all', 1413678355, 47, 1413678438, 47),
(127, 85, 7, 'all', 1413678359, 47, 1413678359, 47),
(130, 87, 3, 'customer', 1413678853, 47, 1413678902, 47),
(131, 87, 4, 'released,closed,reopen', 1413678853, 47, 1413678946, 47),
(132, 87, 5, 'all', 1413678853, 47, 1413678853, 47),
(133, 88, 7, 'order_status,order_status_new', 1413678853, 47, 1413678976, 47),
(134, 89, 6, 'TRUE', 1413678878, 47, 1413678878, 47),
(135, 90, 8, 'TRUE', 1413678880, 47, 1413678880, 47),
...
(140, 92, 6, 'all', 1413687230, 44, 1413687309, 44),
...
(147, 96, 6, 'all', 1413687333, 44, 1413687367, 44),
...
(154, 100, 6, 'all', 1413687442, 44, 1413687442, 44),
...
(159, 104, 6, 'TRUE', 1413687513, 44, 1413687670, 44),
...
(175, 112, 6, 'TRUE', 1413687790, 44, 1413687818, 44),
...
(182, 116, 6, 'all', 1413687843, 44, 1413687843, 44),
...
(44, 'administrator', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'male', '超级管理员', 'yacole@qq.com', '13777777777', '13989775601', '乐清柳市镇', '超级管理员', 0, 1, 0, 1, -1, 1412039595, 1413675969, 44),
