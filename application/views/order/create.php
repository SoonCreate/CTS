...
<div class="container-fluid userd">
    <dl class="row dl-horizontal">
        ...
        <dd>
            <select name="severity" id="severity" data-dojo-type="dijit/form/Select">
    ...
    <dl class="row dl-horizontal">
        ...
        <dd>
            <select name="frequency" id="frequency" data-dojo-type="dijit/form/Select">
    ...
    <dl class="row dl-horizontal">
        ...
        <dd>
            <select name="category" id="category" data-dojo-type="dijit/form/Select">
    ...
    <dl class="row dl-horizontal">
        ...
        <dd><input name="title" id="title" type="text" data-dojo-type="dijit/form/TextBox"/></dd>
    </dl>
    <dl class="row dl-horizontal">
...
<div class="container-fluid userd">
    <dl class="row dl-horizontal">
        ...
        <dd><input name="contact" id="contact" type="text" data-dojo-type="dijit/form/TextBox"/></dd>
    </dl>
    <dl class="row dl-horizontal">
        <dt><label for="mobile_telephone">*手机号码</label></dt>
        <dd><input name="mobile_telephone" id="mobile_telephone" type="text" data-dojo-type="dijit/form/TextBox"/>填写手机号码，如果“自己”之前有填写过，则自动带出相关信息</dd>
    </dl>
    <dl class="row dl-horizontal">
        <dt><label for="phone_number">公司电话</label></dt>
        <dd><input name="phone_number" id="phone_number" type="text" data-dojo-type="dijit/form/TextBox"/></dd>
    </dl>
    <dl class="row dl-horizontal">
        <dt><label for="full_name">公司名称</label></dt>
        <dd><input name="full_name" id="full_name" type="text" data-dojo-type="dijit/form/TextBox"/></dd>
    </dl>
    <dl class="row dl-horizontal">
        <dt><label for="address">公司地址</label></dt>
        <dd><input name="address" id="address" type="text" data-dojo-type="dijit/form/TextBox"/></dd>
    </dl>

</div>
<div class="row panelbottom">
    <input name="order_type" id="order_type" type="hidden" value="<?= $order_type ?>"/>
    <button type="submit" data-dojo-type="dijit/form/Button" class="success">提交</button>
</form>
</div>
